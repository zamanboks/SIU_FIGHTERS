...
const Payment = () => {
    ...
    const handlesubmit= ()=>{
        alert('Congratulaion Payment Successfully')
        navigate("/oneMathBook", { replace: true });
    }
    return (
         ...
         <div class="card text-black">
           <div class="card-body p-md-5">
             <div class="row justify-content-center">
              ...
              required />
                       <label class="form-label" for="form3Example3c">Enter your mobile bank Account number</label>
                     </div>
                   </div>
                   ...
                   <div class="d-flex flex-row align-items-center mb-4">
                     ...
                     <input type="password" id="form3Example4c" class="form-control" 
                            name="password_1"  
                            required/>
                       <label class="form-label" for="form3Example4c">TXID</label>
                     </div>
                   </div>
